...
for (i in 1:T){
  for (j in 1:10){  
    ...
    # This formula comes from the dynamic equations 
...
###################################################################################################################
# Plot SEDUQR graphs
par(mfrow=c(1, 2), lwd=1)

# Students
X_lim <- seq(1,T,by=1)
plot(da$S.Student~X_lim, pch=15, col="black", main = "Baseline SEDUQR Model for Student", type = "l", xlab = "Time (day)", ylab = "Number of Students", xlim = c(0,T), ylim = c(0,100))
...
legend(77, 60 ,c("S","E","D", "U", "Q", "R"),col=c("DeepPink","DarkTurquoise","RosyBrown", "green", "darkgreen", "darkblue"),
       text.col=c("DeepPink","DarkTurquoise","RosyBrown", "green", "darkgreen", "darkblue"),lty=c(1,1,1,1,1,1),
       cex=0.6, x.intersp = 1)

abline(v=90,col="dark grey", lty=2)
legend(60,100, "The End of Term", col="dark grey", cex=0.6, bty = "n")
abline(h=83, col="grey", lty=2)
text(90, da$R.Student[90],round(da$R.Student[90],3), cex = 0.6, pos = 2, col = "darkblue")
text(90, da$S.Student[90],round(da$S.Student[90],3), cex = 0.6, pos = 3, col = "DeepPink")


# Staffs
X_lim <- seq(1,T,by=1)
plot(da$S.Staff~X_lim, pch=15, col="black", main = "Baseline SEDUQR Model for Staff", type = "l", xlab = "Time (day)", ylab = "Number of Staffs", xlim = c(0,T), ylim = c(0,35))
...
legend(77, 20,c("S","E","D", "U", "Q", "R"),col=c("DeepPink","DarkTurquoise","RosyBrown", "green", "darkgreen", "darkblue"),
       text.col=c("DeepPink","DarkTurquoise","RosyBrown", "green", "darkgreen", "darkblue"),lty=c(1,1,1,1,1,1),
       cex=0.6)

abline(v=90,col="dark grey", lty=2)
legend(60,35, "The End of Term", col="dark grey", cex=0.6, bty = "n")
abline(h=7.5,col="grey", lty=2)
text(90, da$R.Staff[90],round(da$R.Staff[90],3), cex = 0.6, pos = 1, col = "darkblue")
text(90, da$S.Staff[90],round(da$S.Staff[90],3), cex = 0.6, pos = 3, col = "DeepPink")
