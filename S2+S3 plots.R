...
lines(da_rp$S.Student, col="orange", lty=1)
lines(da_t$S.Student, col="blue", lty=1)


legend(150, 60 ,c("Baseline", "S(2) : Allow Staff Replacement","S(3) : Allow Tutor Group"),
       col=c("black", "black"),
...
lines(da_rp$E.Student, col="orange", lty=1)
lines(da_t$E.Student, col="blue", lty=1)
...
lines(da_rp$D.Student, col="orange", lty=1)
lines(da_t$D.Student, col="blue", lty=1)
...
lines(da_rp$U.Student, col="orange", lty=1)
lines(da_t$U.Student, col="blue", lty=1)
...
lines(da_rp$Q.Student, col="orange", lty=1)
lines(da_t$Q.Student, col="blue", lty=1)
...
lines(da_rp$R.Student, col="orange", lty=1)
lines(da_t$R.Student, col="blue", lty=1)
...
lines(da_rp$S.Staff, col="orange", lty=1)
lines(da_t$S.Staff, col="blue", lty=1)


legend(150, 50 ,c("Baseline", "S(2) : Allow Staff Replacement","S(3) : Allow Tutor Group"),
       col=c("black", "black"),
       text.col=c("black", "orange", "blue"),lty=c(1,1,1),
       cex=0.57, bty="n")
...
lines(da_rp$E.Staff, col="orange", lty=1)
lines(da_t$E.Staff, col="blue", lty=1)
...
lines(da_rp$D.Staff, col="orange", lty=1)
lines(da_t$D.Staff, col="blue", lty=1)
...
lines(da_rp$U.Staff, col="orange", lty=1)
lines(da_t$U.Staff, col="blue", lty=1)
...
lines(da_rp$Q.Staff, col="orange", lty=1)
lines(da_t$Q.Staff, col="blue", lty=1)
...
lines(da_rp$R.Staff, col="orange", lty=1)
lines(da_t$R.Staff, col="blue", lty=1)


legend(100, 50 ,c("Baseline", "S(2) : Allow Staff Replacement","S(3) : Allow Tutor Group"),
       col=c("black", "black"),
       text.col=c("black", "orange", "blue"),lty=c(1,1,1),
       cex=0.57, bty="n")
