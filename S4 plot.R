...
lines(da_rp_t$S.Student, col="orange", lty=1)


legend(150, 60 ,c("Baseline", "S(4) : Allow Student Replacement and Tutor Group"),
       col=c("black", "black"),
...
lines(da_rp_t$E.Student, col="orange", lty=1)
...
lines(da_rp_t$D.Student, col="orange", lty=1)
...
lines(da_rp_t$U.Student, col="orange", lty=1)
...
lines(da_rp_t$Q.Student, col="orange", lty=1)
...
lines(da_rp_t$R.Student, col="orange", lty=1)
...
lines(da_rp_t$S.Staff, col="orange", lty=1)


legend(150, 50 ,c("Baseline", "S(4) : Allow Staff Replacement and Tutor Group"),
       col=c("black", "black"),
       text.col=c("black", "orange", "blue"),lty=c(1,1,1),
       cex=0.57, bty="n")
...
lines(da_rp_t$E.Staff, col="orange", lty=1)
...
lines(da_rp_t$D.Staff, col="orange", lty=1)
...
lines(da_rp_t$U.Staff, col="orange", lty=1)
...
lines(da_rp_t$Q.Staff, col="orange", lty=1)
...
lines(da_rp_t$R.Staff, col="orange", lty=1)
