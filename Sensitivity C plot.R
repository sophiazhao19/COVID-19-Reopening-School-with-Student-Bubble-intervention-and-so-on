...
lines(da_C1$S.Student, col="black", lty=2)
lines(da_C2$S.Student, col="black", lty=3)
...
lines(da_C1$E.Student, col="black", lty=2)
lines(da_C2$E.Student, col="black", lty=3)
...
lines(da_C1$D.Student, col="black", lty=2)
lines(da_C2$D.Student, col="black", lty=3)
...
lines(da_C1$U.Student, col="black", lty=2)
lines(da_C2$U.Student, col="black", lty=3)
...
lines(da_C1$Q.Student, col="black", lty=2)
lines(da_C2$Q.Student, col="black", lty=3)
...
lines(da_C1$R.Student, col="black", lty=2)
lines(da_C2$R.Student, col="black", lty=3)

legend(150, 30 ,c("C(aj) = (0.79,1)", "C(aj) = (0.632,0.8)", "C(aj) = (0.948,1.2)"),
       col="black",
...
lines(da_C1$S.Staff, col="black", lty=2)
lines(da_C2$S.Staff, col="black", lty=3)
...
lines(da_C1$E.Staff, col="black", lty=2)
lines(da_C2$E.Staff, col="black", lty=3)
...
lines(da_C1$D.Staff, col="black", lty=2)
lines(da_C2$D.Staff, col="black", lty=3)
...
lines(da_C1$U.Staff, col="black", lty=2)
lines(da_C2$U.Staff, col="black", lty=3)
...
lines(da_C1$Q.Staff, col="black", lty=2)
lines(da_C2$Q.Staff, col="black", lty=3)
...
lines(da_C1$R.Staff, col="black", lty=2)
lines(da_C2$R.Staff, col="black", lty=3)

legend(150, 45 ,c("C(aj) = (0.79,1)", "C(aj) = (0.632,0.8)", "C(aj) = (0.948,1.2)"),
       col="black",
       text.col="black",lty=c(1,2,3),
       cex=0.9, bty="n")
