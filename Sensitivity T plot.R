...
lines(da_T1$S.Student, col="black", lty=2)
lines(da_T2$S.Student, col="black", lty=3)
...
lines(da_T1$E.Student, col="black", lty=2)
lines(da_T2$E.Student, col="black", lty=3)
...
lines(da_T1$D.Student, col="black", lty=2)
lines(da_T2$D.Student, col="black", lty=3)
...
lines(da_T1$U.Student, col="black", lty=2)
lines(da_T2$U.Student, col="black", lty=3)
...
lines(da_T1$Q.Student, col="black", lty=2)
lines(da_T2$Q.Student, col="black", lty=3)
...
lines(da_T1$R.Student, col="black", lty=2)
lines(da_T2$R.Student, col="black", lty=3)

legend(150, 30 ,c("T(ai) = (0.64,1)", "T(ai) = (0.512,0.8)", "T(ai) = (0.768,1.2)"),
       col="black",
...
lines(da_T1$S.Staff, col="black", lty=2)
lines(da_T2$S.Staff, col="black", lty=3)
...
lines(da_T1$E.Staff, col="black", lty=2)
lines(da_T2$E.Staff, col="black", lty=3)
...
lines(da_T1$D.Staff, col="black", lty=2)
lines(da_T2$D.Staff, col="black", lty=3)
...
lines(da_T1$U.Staff, col="black", lty=2)
lines(da_T2$U.Staff, col="black", lty=3)
...
lines(da_T1$Q.Staff, col="black", lty=2)
lines(da_T2$Q.Staff, col="black", lty=3)
...
lines(da_T1$R.Staff, col="black", lty=2)
lines(da_T2$R.Staff, col="black", lty=3)

legend(150, 45 ,c("T(ai) = (0.64,1)", "T(ai) = (0.512,0.8)", "T(ai) = (0.768,1.2)"),
       col="black",
       text.col="black",lty=c(1,2,3),
       cex=0.9, bty="n")
