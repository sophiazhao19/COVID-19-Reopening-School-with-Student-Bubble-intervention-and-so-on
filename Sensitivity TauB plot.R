...
lines(da_tauB1$S.Student, col="black", lty=2)
lines(da_tauB2$S.Student, col="black", lty=3)
...
lines(da_tauB1$E.Student, col="black", lty=2)
lines(da_tauB2$E.Student, col="black", lty=3)
...
lines(da_tauB1$D.Student, col="black", lty=2)
lines(da_tauB2$D.Student, col="black", lty=3)
...
lines(da_tauB1$U.Student, col="black", lty=2)
lines(da_tauB2$U.Student, col="black", lty=3)
...
lines(da_tauB1$Q.Student, col="black", lty=2)
lines(da_tauB2$Q.Student, col="black", lty=3)
...
lines(da_tauB1$R.Student, col="black", lty=2)
lines(da_tauB2$R.Student, col="black", lty=3)

legend(180, 30 ,c(expression(paste(tau, "B = ", 0.54)),
                  expression(paste(tau, "B = ", 0.432)),
                  expression(paste(tau, "B = ", 0.648))),
       col="black",
...
lines(da_tauB1$S.Staff, col="black", lty=2)
lines(da_tauB2$S.Staff, col="black", lty=3)
...
lines(da_tauB1$E.Staff, col="black", lty=2)
lines(da_tauB2$E.Staff, col="black", lty=3)
...
lines(da_tauB1$D.Staff, col="black", lty=2)
lines(da_tauB2$D.Staff, col="black", lty=3)
...
lines(da_tauB1$U.Staff, col="black", lty=2)
lines(da_tauB2$U.Staff, col="black", lty=3)
...
lines(da_tauB1$Q.Staff, col="black", lty=2)
lines(da_tauB2$Q.Staff, col="black", lty=3)
...
lines(da_tauB1$R.Staff, col="black", lty=2)
lines(da_tauB2$R.Staff, col="black", lty=3)

legend(180, 45 ,c(expression(paste(tau, "B = ", 0.54)),
                  expression(paste(tau, "B = ", 0.432)),
                  expression(paste(tau, "B = ", 0.648))),
       col="black",
       text.col="black",lty=c(1,2,3),
