...
lines(da_tauO1$S.Student, col="black", lty=2)
lines(da_tauO2$S.Student, col="black", lty=3)
...
lines(da_tauO1$E.Student, col="black", lty=2)
lines(da_tauO2$E.Student, col="black", lty=3)
...
lines(da_tauO1$D.Student, col="black", lty=2)
lines(da_tauO2$D.Student, col="black", lty=3)
...
lines(da_tauO1$U.Student, col="black", lty=2)
lines(da_tauO2$U.Student, col="black", lty=3)
...
lines(da_tauO1$Q.Student, col="black", lty=2)
lines(da_tauO2$Q.Student, col="black", lty=3)
...
lines(da_tauO1$R.Student, col="black", lty=2)
lines(da_tauO2$R.Student, col="black", lty=3)

legend(180, 30 ,c(expression(paste(tau, "O = ", 0.5)),
                  expression(paste(tau, "O = ", 0.4)),
                  expression(paste(tau, "O = ", 0.6))),
       col="black",
...
lines(da_tauO1$S.Staff, col="black", lty=2)
lines(da_tauO2$S.Staff, col="black", lty=3)
...
lines(da_tauO1$E.Staff, col="black", lty=2)
lines(da_tauO2$E.Staff, col="black", lty=3)
...
lines(da_tauO1$D.Staff, col="black", lty=2)
lines(da_tauO2$D.Staff, col="black", lty=3)
...
lines(da_tauO1$U.Staff, col="black", lty=2)
lines(da_tauO2$U.Staff, col="black", lty=3)
...
lines(da_tauO1$Q.Staff, col="black", lty=2)
lines(da_tauO2$Q.Staff, col="black", lty=3)
...
lines(da_tauO1$R.Staff, col="black", lty=2)
lines(da_tauO2$R.Staff, col="black", lty=3)

legend(180, 45 ,c(expression(paste(tau, "O = ", 0.5)),
                  expression(paste(tau, "O = ", 0.4)),
                  expression(paste(tau, "O = ", 0.6))),
       col="black",
       text.col="black",lty=c(1,2,3),
