...
lines(da_d1$S.Student, col="black", lty=2)
lines(da_d2$S.Student, col="black", lty=3)
...
lines(da_d1$E.Student, col="black", lty=2)
lines(da_d2$E.Student, col="black", lty=3)
...
lines(da_d1$D.Student, col="black", lty=2)
lines(da_d2$D.Student, col="black", lty=3)
...
lines(da_d1$U.Student, col="black", lty=2)
lines(da_d2$U.Student, col="black", lty=3)
...
lines(da_d1$Q.Student, col="black", lty=2)
lines(da_d2$Q.Student, col="black", lty=3)
...
lines(da_d1$R.Student, col="black", lty=2)
lines(da_d2$R.Student, col="black", lty=3)

legend(150, 30 ,c(expression(paste(d, " =  (0.1, 0.3)")),                   
                  expression(paste(d, " =  (0.08, 0.24)")),                   
                  expression(paste(d, " =  (0.12, 0.36)"))),
       col="black",
...
lines(da_d1$S.Staff, col="black", lty=2)
lines(da_d2$S.Staff, col="black", lty=3)
...
lines(da_d1$E.Staff, col="black", lty=2)
lines(da_d2$E.Staff, col="black", lty=3)
...
lines(da_d1$D.Staff, col="black", lty=2)
lines(da_d2$D.Staff, col="black", lty=3)
...
lines(da_d1$U.Staff, col="black", lty=2)
lines(da_d2$U.Staff, col="black", lty=3)
...
lines(da_d1$Q.Staff, col="black", lty=2)
lines(da_d2$Q.Staff, col="black", lty=3)
...
lines(da_d1$R.Staff, col="black", lty=2)
lines(da_d2$R.Staff, col="black", lty=3)

legend(150, 45 ,c(expression(paste(d, " =  (0.1, 0.3)")),                   
                  expression(paste(d, " =  (0.08, 0.24)")),                   
                  expression(paste(d, " =  (0.12, 0.36)"))),
       col="black",
       text.col="black",lty=c(1,2,3),
