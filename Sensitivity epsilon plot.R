...
lines(da_epsilon1$S.Student, col="black", lty=2)
lines(da_epsilon2$S.Student, col="black", lty=3)
...
lines(da_epsilon1$E.Student, col="black", lty=2)
lines(da_epsilon2$E.Student, col="black", lty=3)
...
lines(da_epsilon1$D.Student, col="black", lty=2)
lines(da_epsilon2$D.Student, col="black", lty=3)
...
lines(da_epsilon1$U.Student, col="black", lty=2)
lines(da_epsilon2$U.Student, col="black", lty=3)
...
lines(da_epsilon1$Q.Student, col="black", lty=2)
lines(da_epsilon2$Q.Student, col="black", lty=3)
...
lines(da_epsilon1$R.Student, col="black", lty=2)
lines(da_epsilon2$R.Student, col="black", lty=3)

legend(150, 30 ,c(expression(paste(epsilon, " = ", 0.2)),
                  expression(paste(epsilon, " = ", 0.14)),
                  expression(paste(epsilon, " = ", 0.24))),
       col="black",
...
lines(da_epsilon1$S.Staff, col="black", lty=2)
lines(da_epsilon2$S.Staff, col="black", lty=3)
...
lines(da_epsilon1$E.Staff, col="black", lty=2)
lines(da_epsilon2$E.Staff, col="black", lty=3)
...
lines(da_epsilon1$D.Staff, col="black", lty=2)
lines(da_epsilon2$D.Staff, col="black", lty=3)
...
lines(da_epsilon1$U.Staff, col="black", lty=2)
lines(da_epsilon2$U.Staff, col="black", lty=3)
...
lines(da_epsilon1$Q.Staff, col="black", lty=2)
lines(da_epsilon2$Q.Staff, col="black", lty=3)
...
lines(da_epsilon1$R.Staff, col="black", lty=2)
lines(da_epsilon2$R.Staff, col="black", lty=3)

legend(150, 45 ,c(expression(paste(epsilon, " = ", 0.138)),                   
                  expression(paste(epsilon, " = ", 0.1104)),                   
                  expression(paste(epsilon, " = ", 0.1656))),
       col="black",
       text.col="black",lty=c(1,2,3),
       cex=0.9, bty="n")
