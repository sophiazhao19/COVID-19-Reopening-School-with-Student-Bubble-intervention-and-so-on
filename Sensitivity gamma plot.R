...
lines(da_gamma1$S.Student, col="black", lty=2)
lines(da_gamma2$S.Student, col="black", lty=3)
...
lines(da_gamma1$E.Student, col="black", lty=2)
lines(da_gamma2$E.Student, col="black", lty=3)
...
lines(da_gamma1$D.Student, col="black", lty=2)
lines(da_gamma2$D.Student, col="black", lty=3)
...
lines(da_gamma1$U.Student, col="black", lty=2)
lines(da_gamma2$U.Student, col="black", lty=3)
...
lines(da_gamma1$Q.Student, col="black", lty=2)
lines(da_gamma2$Q.Student, col="black", lty=3)
...
lines(da_gamma1$R.Student, col="black", lty=2)
lines(da_gamma2$R.Student, col="black", lty=3)

legend(150, 30 ,c(expression(paste(gamma, " = ", 0.1)),
                  expression(paste(gamma, " = ", 0.08)),
                  expression(paste(gamma, " = ", 0.13))),
       col="black",
...
lines(da_gamma1$S.Staff, col="black", lty=2)
lines(da_gamma2$S.Staff, col="black", lty=3)
...
lines(da_gamma1$E.Staff, col="black", lty=2)
lines(da_gamma2$E.Staff, col="black", lty=3)
...
lines(da_gamma1$D.Staff, col="black", lty=2)
lines(da_gamma2$D.Staff, col="black", lty=3)
...
lines(da_gamma1$U.Staff, col="black", lty=2)
lines(da_gamma2$U.Staff, col="black", lty=3)
...
lines(da_gamma1$Q.Staff, col="black", lty=2)
lines(da_gamma2$Q.Staff, col="black", lty=3)
...
lines(da_gamma1$R.Staff, col="black", lty=2)
lines(da_gamma2$R.Staff, col="black", lty=3)

legend(150, 45 ,c(expression(paste(gamma, " = ", 0.1)),
                  expression(paste(gamma, " = ", 0.08)),
                  expression(paste(gamma, " = ", 0.13))),
       col="black",
       text.col="black",lty=c(1,2,3),
