...
lines(da_theta1$S.Student, col="black", lty=2)
lines(da_theta2$S.Student, col="black", lty=3)
...
lines(da_theta1$E.Student, col="black", lty=2)
lines(da_theta2$E.Student, col="black", lty=3)
...
lines(da_theta1$D.Student, col="black", lty=2)
lines(da_theta2$D.Student, col="black", lty=3)
...
lines(da_theta1$U.Student, col="black", lty=2)
lines(da_theta2$U.Student, col="black", lty=3)
...
lines(da_theta1$Q.Student, col="black", lty=2)
lines(da_theta2$Q.Student, col="black", lty=3)
...
lines(da_theta1$R.Student, col="black", lty=2)
lines(da_theta2$R.Student, col="black", lty=3)

legend(150, 30 ,c(expression(paste(theta, " = ", 0.75)),
                  expression(paste(theta, " = ", 0.6)),
                  expression(paste(theta, " = ", 0.9))),
       col="black",
...
lines(da_theta1$S.Staff, col="black", lty=2)
lines(da_theta2$S.Staff, col="black", lty=3)
...
lines(da_theta1$E.Staff, col="black", lty=2)
lines(da_theta2$E.Staff, col="black", lty=3)
...
lines(da_theta1$D.Staff, col="black", lty=2)
lines(da_theta2$D.Staff, col="black", lty=3)
...
lines(da_theta1$U.Staff, col="black", lty=2)
lines(da_theta2$U.Staff, col="black", lty=3)
...
lines(da_theta1$Q.Staff, col="black", lty=2)
lines(da_theta2$Q.Staff, col="black", lty=3)
...
lines(da_theta1$R.Staff, col="black", lty=2)
lines(da_theta2$R.Staff, col="black", lty=3)

legend(150, 45 ,c(expression(paste(theta, " = ", 0.75)),                   
                  expression(paste(theta, " = ", 0.6)),                   
                  expression(paste(theta, " = ", 0.9))),
       col="black",
       text.col="black",lty=c(1,2,3),
