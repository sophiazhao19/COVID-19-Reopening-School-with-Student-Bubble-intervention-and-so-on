...
for (i in 1:T){
  for (j in 1:10){  
    ...
    da10[i,paste("S.", "Staff", sep = "")] <- sum(S.Staff[i,])  
    da10[i,paste("E.", "Staff", sep = "")] <- sum(E.Staff[i,])  
    da10[i,paste("D.", "Staff", sep = "")] <- sum(D.Staff[i,])  
    da10[i,paste("U.", "Staff", sep = "")] <- sum(U.Staff[i,]) 
    da10[i,paste("Q.", "Staff", sep = "")] <- sum(Q.Staff[i,]) 
    da10[i,paste("R.", "Staff", sep = "")] <- sum(R.Staff[i,]) 
